...
@Entity
public class DataCollectionEntry implements Comparable<DataCollectionEntry> {
    ...
    public DataCollectionEntry(String state, long timestamp){
    	this.state = state;
    ...
    public boolean equals(Object o) {
        ...
        DataCollectionEntry that = (DataCollectionEntry) o;
